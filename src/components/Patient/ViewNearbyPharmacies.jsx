...
const ViewNearbyPharmacies = ({ onChat, sidebarOpen }) => {
  ...
  return (
    ...
    >
      ...
      <div className="p-4 sm:p-6 lg:p-8 rounded-2xl m-4 sm:m-6" style={{ backgroundColor: '#256C5C' }}>
      ...
      <div className="max-w-full mx-auto p-3 sm:p-4 lg:p-6">
        ...
        {location && (
          <div className="p-4 sm:p-6 lg:p-8 rounded-2xl mb-6 sm:mb-8" style={{ backgroundColor: '#256C5C' }}>
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4 mb-4 sm:mb-6">
              <div className="p-3 sm:p-4 bg-white bg-opacity-20 rounded-xl w-fit">
                <Navigation className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-white" />
              </div>
              <div className="flex-1">
                <h3 className="text-xl sm:text-2xl font-bold text-white">Map View</h3>
                <p className="text-xs sm:text-sm text-gray-200 mt-1">Interactive pharmacy locations</p>
              </div>
            </div>

            <div className="p-3 sm:p-4 rounded-2xl" style={{ backgroundColor: '#CAE7E1' }}>
        ...
        <div className="p-4 sm:p-6 lg:p-8 rounded-2xl" style={{ backgroundColor: '#256C5C' }}>
          ...
          {loading && (
            <div className="rounded-xl p-8 sm:p-10 lg:p-12" style={{ backgroundColor: '#CAE7E1' }}>
          ...
          {!loading && pharmacies.length > 0 && (
            <div className="grid grid-cols-1 gap-4 sm:gap-6">
              {pharmacies.map((ph) => (
                <div
                  key={ph._id}
                  className="rounded-2xl p-4 sm:p-5 lg:p-6 hover:shadow-xl transition-all duration-300 border border-gray-200"
                ...
                >
                  ...
                  <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                    <div className="flex items-start gap-2 sm:gap-3">
                      <div className="p-1.5 sm:p-2 bg-white bg-opacity-60 rounded-lg flex-shrink-0">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div className="p-1.5 sm:p-2 bg-white bg-opacity-60 rounded-lg">
                  ...
                  <div className="flex items-center gap-2 sm:gap-3 pt-3 sm:pt-4 border-t border-white border-opacity-50">
                    <button
